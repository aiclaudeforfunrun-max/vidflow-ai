      ...
      <main className="main">
        ...
        {msg && (
          <div style={{
            ...
            color: "#10b981", padding: "12px 16px", borderRadius: "10px", marginBottom: "16px", fontSize: "13px",
          }}>✅ {msg}</div>
        )}
        {error && (
          <div style={{
            background: "rgba(239,68,68,0.10)", border: "1px solid rgba(239,68,68,0.30)",
            color: "#ef4444", padding: "12px 16px", borderRadius: "10px", marginBottom: "16px", fontSize: "13px",
          }}>❌ {error}</div>
        )}
